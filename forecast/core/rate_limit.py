"""
Rate Limiting for Sapheneia API
...
RATE_LIMITS = {
    ...
    "inference": f"{settings.RATE_LIMIT_INFERENCE_PER_MINUTE}/minute",
    "initialization": "5/minute",  # Model initialization is resource-intensive
...
def get_rate_limit(limit_type: str = "default") -> str:
    ...
    Args:
        limit_type: Type of rate limit (default, inference, initialization, health)
