def example_usage():
    ...
    print("="*60)
    current_price = 100.0
    portfolio_value = TradingStrategy.get_portfolio_value(current_position, current_price, available_cash)
    portfolio_return = TradingStrategy.get_portfolio_return(current_position, current_price, available_cash, initial_capital)
